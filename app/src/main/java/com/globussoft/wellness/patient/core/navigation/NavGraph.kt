...
import com.globussoft.wellness.patient.feature.booking.presentation.screen.WaitlistScreen
...
import com.globussoft.wellness.patient.feature.booking.presentation.viewmodel.WaitlistNavEvent
import com.globussoft.wellness.patient.feature.booking.presentation.viewmodel.WaitlistViewModel
...
import com.globussoft.wellness.patient.feature.catalog.presentation.screen.CatalogTabScreen
    ...
    Scaffold(
        ...
        NavHost(
            ...
            composable(
                ...
                deepLinks = listOf(navDeepLink { uriPattern = "wellnesspatient://screen/waitlist" }),
            ) {
